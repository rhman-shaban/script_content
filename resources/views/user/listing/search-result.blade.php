            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-9">
                    <div class="row">
                                ...
                                @if ($listingAminity->listing->expired_date==null)
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__featured_single list_view">
                                            <a class="list_images" href="{{ route('listing.show',$listingAminity->listing->slug) }}" class="">
                                                <img src="{{ asset($listingAminity->listing->thumbnail_image) }}" alt="images" class="img-fluid w-100">
                                            </a>

                                            @guest
                                            <span class="love"><a data-bs-toggle="modal" data-bs-target="#exampleModal" href="javascript::void"><i class="fas fa-heart"></i></a></span>
                                            @else
                                            <span class="love"><a href="{{ route('user.add.to.wishlist',$listingAminity->listing->id) }}"><i class="fas fa-heart"></i></a></span>
                                            @endguest

                                            <a class="map" data-bs-toggle="modal" data-bs-target="#listngPopUp-{{ $listingAminity->listing->id }}" href="#"><i class="fal fas fa-eye"></i></a>

                                            <div class="wsus__featured_single_text">
                                            <span class="small_text {{ $color }}"><a href="{{ route('listings',['category_slug'=>$listingAminity->listing->listingCategory->slug, 'page_type' => 'list_view']) }}">{{ $listingAminity->listing->listingCategory->name }}</a></span>
                                                ...
                                                <h6><a href="{{ route('listing.show',$listingAminity->listing->slug) }}">{{ $listingAminity->listing->title }}</a></h6>
                                                <p><i class="fa fa-map-marker"></i> {{ $listingAminity->listing->address }}</p>
                                                <p class="list_details">{{ $listingAminity->listing->sort_description }}</p>
                                    ...
                                    @elseif($listingAminity->listing->expired_date > date('Y-m-d'))
                                        ...
                                        <div class="col-xl-12">
                                            <div class="wsus__featured_single list_view">
                                                ...
                                                <a class="map" data-bs-toggle="modal" data-bs-target="#listngPopUp-{{ $listingAminity->listing->id }}" href="{{ route('listings',['category_slug'=>$listingAminity->listing->listingCategory->slug, 'page_type' => 'list_view']) }}"><i class="fal fas fa-eye"></i></a>

                                                <div class="wsus__featured_single_text">
                                                <span class="small_text {{ $color }}"><a href="#">{{ $listingAminity->listing->listingCategory->name }}</a></span>
                                                    @if ($listingAminity->listing->listingSchedule->count()> 0)
                                                        @php
                                ...
                                @if ($listingAminity->listing->expired_date==null)
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="wsus__featured_single">
                                            <a class="list_images" href="{{ route('listing.show',$listingAminity->listing->slug) }}">
                                                <img src="{{ asset($listingAminity->listing->thumbnail_image) }}" alt="images" class="img-fluid w-100">
                                            </a>
                                            ...
                                            <span class="small_text {{ $color }}"><a href="{{ route('listings',['category_slug'=>$listingAminity->listing->listingCategory->slug, 'page_type' => 'list_view']) }}">{{ $listingAminity->listing->listingCategory->name }}</a></span>
                                                ...
                                                @endif
                                                <h6><a href="{{ route('listing.show',$listingAminity->listing->slug) }}">{{ $listingAminity->listing->title }}</a></h6>
                                                <p class="address"><i class="fa fa-map-marker"></i> {{ $listingAminity->listing->address }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @elseif($listingAminity->listing->expired_date > date('Y-m-d'))
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="wsus__featured_single">
                                            ...
                                            <a class="map" data-bs-toggle="modal" data-bs-target="#listngPopUp-{{ $listingAminity->listing->id }}" href="javascript"><i class="fal fas fa-eye"></i></a>
                                            <div class="wsus__featured_single_text">
                                            <span class="small_text {{ $color }}"><a href="{{ route('listings',['category_slug'=>$listingAminity->listing->listingCategory->slug, 'page_type' => 'list_view']) }}">{{ $listingAminity->listing->listingCategory->name }}</a></span>
                                                @if ($listingAminity->listing->reviews->where('status',1)->count() > 0)
                                                @php
                        ...
                        {{ $listingAminities->links('user.paginator') }}

                        @foreach ($listingAminities as $index => $listingAminity)
                            <section id="wsus__map_popup">
                                <div class="modal fade" id="listngPopUp-{{ $listingAminity->listing->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-xl-12 col-md-12">
                                                    <div class="map_popup_content">
                                                        <img src="{{ $listingAminity->listing->thumbnail_image ? asset($listingAminity->listing->thumbnail_image) : '' }}" alt="images" class="img-fluid w-100">
                                                        <div class="map_popup_text">
                                                            @if ($listingAminity->listing->is_featured==1)
                                                            <span><i class="far fa-star"></i>  {{ $websiteLang->where('id',10)->first()->custom_text }}</span>
                                                            @endif

                                                            @if ($listingAminity->listing->verified)
                                                                <span class="red"><i class="far fa-check"></i> {{ $websiteLang->where('id',11)->first()->custom_text }}</span>
                                                            @endif
                                                            <h5>{{ $listingAminity->listing->title }}</h5>

                                                            @if ($listingAminity->listing->phone)
                                                                <a class="call" href="callto:{{ $listingAminity->listing->phone }}"><i class="fal fa-phone-alt"></i> {{ $listingAminity->listing->phone }}</a>
                                                            @endif
                                                            @if ($listingAminity->listing->email)
                                                            <a class="mail" href="mailto:{{ $listingAminity->listing->email }}"><i class="fal fa-envelope"></i> {{ $listingAminity->listing->email }}</a>

                                                            @endif

                                                            <p>{{ $listingAminity->listing->sort_description }}</p>
                                                            <a class="read_btn" href="{{ route('listing.show',$listingAminity->listing->slug) }}">{{ $websiteLang->where('id',12)->first()->custom_text }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-xl-12 col-md-12">
                                                    <div class="map_popup_content_map">
                                                        {!! $listingAminity->listing->google_map_embed_code !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
