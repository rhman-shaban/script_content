        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    @if ($listing->listingVideos->count()>0)
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm ('{{ $confirmNotify }}')" href="{{ route('admin.delete.listing.video',$video->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
                    ...
                    <form action="{{ route('admin.listing.new.video') }}" method="post">
                        @csrf
