...
@section('title')
<title>{{ $websiteLang->where('id',170)->first()->custom_text }}</title>
@endsection
        ...
        <div class="col-md-10">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',170)->first()->custom_text }}</h6>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><img class="custom_img_width" src="{{ $image->image ? url($image->image) :'' }}" alt=""></td>
