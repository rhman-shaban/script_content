                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $user_email }}</td>
                                <td>{{ $websiteLang->where('id',212)->first()->custom_text }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $user_phone }}</td>
                                <td>{{ $websiteLang->where('id',213)->first()->custom_text }}</td>
                            </tr>
                            <tr>
                                @php
                                    $subject="{{subject}}";
                                @endphp
                                <td>{{ $subject }}</td>
                                <td>{{ $websiteLang->where('id',214)->first()->custom_text }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $message }}</td>
                                <td>{{ $websiteLang->where('id',41)->first()->custom_text }}</td>
                            </tr>
