                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ $websiteLang->where('id',404)->first()->custom_text }}</h1>
                                </div>
                                ...
                                <div class="text-center">
                                    <a class="small" href="{{ route('admin.forget.password') }}">{{ $websiteLang->where('id',405)->first()->custom_text }}</a>
                                </div>
                            </div>
                        </div>
