    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('staff.listing.new.logo') }}" enctype="multipart/form-data" method="post">
                        @csrf
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('staff.listing.new.thumbnail') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="form-group">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('staff.listing.new.banner') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="form-group">
                ...
                <div class="card-body">
                    @if ($listing->listingImages->count()>0)
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td><img class="listing-slider-image" src="{{ $image->image ? asset($image->image) : '' }}" alt="listing image"></td>
                                <td>
                                    <a onclick="return confirm ('{{ $confirmNotify }}')" href="{{ route('staff.delete.listing.image',$image->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
                    ...
                    <form action="{{ route('staff.listing.new.image') }}" enctype="multipart/form-data" method="post">
                        @csrf
