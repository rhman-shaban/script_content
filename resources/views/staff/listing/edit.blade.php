...
@section('title')
<title>{{ $websiteLang->where('id',56)->first()->custom_text }}</title>
@endsection
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('staff.listing.update',$listing->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <a href="{{ route('download-listing-file',$listing->file) }}">{{ $listing->file }}</a> <a onclick="return confirm('{{ $confirmNotify }}')" href="{{ route('staff.delete-file',$listing->id) }}" class="text-danger ml-3"><i class="fa fa-trash" aria-hidden="true"></i> </a>
                                    </div>
                                </div>
                            </div>
                            @endif
